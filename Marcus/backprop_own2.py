...
def loss(y, inputweight_1, inputweight_2, outputweight, X):
    ...
    for i in range(0, len(y), 1):
        res += (y[i] - output(inputweight_1, inputweight_2, outputweight, X)[i])
    return res
...
while (abs(loss(y, inputweight_1, inputweight_2, outputweight, X)) > z):
    ...
    print(loss(y, inputweight_1, inputweight_2, outputweight, X))